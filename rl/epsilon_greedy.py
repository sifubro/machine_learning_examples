...
## SEE epsilon_greedy_starter.py
## TODO: Implement deplaying epsilon strategy
## TODO: Implement deplaying epsilon strategy
## TODO: Implement deplaying epsilon strategy
...
class Bandit:
  def __init__(self, p):
    # p: the *true* win rate for this bandit
    self.p = p
    self.p_estimate = 0.
  ...
  def update(self, x):
    # update the current estimate of the bandits mean
    self.N += 1.
